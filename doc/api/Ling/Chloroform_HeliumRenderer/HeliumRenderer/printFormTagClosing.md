...
HeliumRenderer::printFormTagClosing
================



HeliumRenderer::printFormTagClosing — Prints the closing form tag.
...
public [HeliumRenderer::printFormTagClosing](https://github.com/lingtalfi/Chloroform_HeliumRenderer/blob/master/doc/api/Ling/Chloroform_HeliumRenderer/HeliumRenderer/printFormTagClosing.md)() : void
...
Source Code
===========
See the source code for method [HeliumRenderer::printFormTagClosing](https://github.com/lingtalfi/Chloroform_HeliumRenderer/blob/master/HeliumRenderer.php#L299-L304)
