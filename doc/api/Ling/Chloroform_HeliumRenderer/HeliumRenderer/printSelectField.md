...
HeliumRenderer::printSelectField
================



HeliumRenderer::printSelectField — Prints the given select field.
...
public [HeliumRenderer::printSelectField](https://github.com/lingtalfi/Chloroform_HeliumRenderer/blob/master/doc/api/Ling/Chloroform_HeliumRenderer/HeliumRenderer/printSelectField.md)(array $field) : void
...
Source Code
===========
See the source code for method [HeliumRenderer::printSelectField](https://github.com/lingtalfi/Chloroform_HeliumRenderer/blob/master/HeliumRenderer.php#L799-L870)
